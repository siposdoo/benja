...
<template>
 ...
 -->
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="naslovweb">Proizvodjač</vs-th>
         <vs-th sort-key="kolicina">Model</vs-th>
        <vs-th sort-key="pjcijena">Tablica</vs-th>
 ...
 <vs-td>
            ...
            <vs-td>
              <p class="product-name font-small truncate">{{ tr.proizvodjac }}</p>
            </vs-td>

             
 <vs-td>
              <p class="product-category">{{ tr.model }}</p>
            </vs-td>

             
            <vs-td>
              <p class="product-price">{{ tr.tablica }}</p>
            </vs-td>
...
<script>
import DataViewSidebar from './KamionSidebar'
...
}else
{
    ...
    getKamioni(){
     ...
     this.$http.get('/api/auth/kamioni', { headers:{
