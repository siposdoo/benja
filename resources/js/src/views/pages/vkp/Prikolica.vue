...
<template>
 ...
 -->
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="naslovweb">Naziv</vs-th>
         <vs-th sort-key="kolicina">Tablica</vs-th>
        <vs-th sort-key="pjcijena">Dodatno</vs-th>
 ...
 <vs-td>
            ...
            <vs-td>
              <p class="product-name font-small truncate">{{ tr.name }}</p>
            </vs-td>

             
 <vs-td>
              <p class="product-category">{{ tr.tablica }}</p>
            </vs-td>

             
            <vs-td>
              <p class="product-price">{{ tr.dodatno }}</p>
            </vs-td>
...
<script>
import DataViewSidebar from './PrikolicaSidebar'
...
}else
{
    ...
    getPrikolice(){
     ...
     this.$http.get('/api/auth/prikolice', { headers:{
